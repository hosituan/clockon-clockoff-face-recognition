...
::google::protobuf::uint8* TestMessage::InternalSerializeWithCachedSizesToArray(
  ...
  for (int i = 0, n = this->repeated_bool_value_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
  ...
  for (int i = 0, n = this->repeated_float_value_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
  ...
  for (int i = 0, n = this->repeated_double_value_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
...
void TestMessage::add_repeated_string_value(::std::string&& value) {
  repeated_string_value_.Add()->assign(std::move(value));
  // @@protoc_insertion_point(field_add:proto3.TestMessage.repeated_string_value)
}
#endif
...
void TestMessage::add_repeated_bytes_value(::std::string&& value) {
  repeated_bytes_value_.Add()->assign(std::move(value));
  // @@protoc_insertion_point(field_add:proto3.TestMessage.repeated_bytes_value)
}
#endif
